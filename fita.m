...
gs = med + intitialparameter(1)*sin(intitialparameter(2)*xm*24/(2*pi)+ intitialparameter(3));
%gs = intitialparameter(1)*sin(intitialparameter(2)*xm + intitialparameter(3));
E = sum(abs(gs - ym).^2);
ya = med + intitialparameter(1)*sin(intitialparameter(2)*24*xm/(2*pi) + intitialparameter(3));
